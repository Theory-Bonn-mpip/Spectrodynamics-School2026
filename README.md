...
The school is supported by funding from **CECAM** and **Psi-k**, which allows us to host an intensive, in-person training event focused on computational spectroscopy across frequency regimes and methodological frameworks.
...
**Important** 
As a simple check that you have read these instructions, please start your application with the word “SpectroDynamics”.
---
