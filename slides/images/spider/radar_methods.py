...
# --------------------------------------------------------------------------
METHODS = {
    "quantum / ab initio": dict(
        values=[1.00, 0.95, 1.00, 0.15, 0.90, 0.15],
        color="#6c5ce7", linestyle="solid", linewidth=2.2, fill=0.13,
    ),
    "classical MD": dict(
        values=[0.35, 0.30, 0.02, 0.60, 0.15, 0.70],
        color="#27ae60", linestyle=(0, (6, 3)), linewidth=2.2, fill=0.13,
    ),
    "coarse-grained": dict(
        values=[0.15, 0.18, 0.02, 0.90, 0.05, 0.95],
        color="#e8552d", linestyle=(0, (1.5, 2)), linewidth=2.4, fill=0.11,
    ),
    "what the problem demands": dict(
        values=[0.88, 0.88, 0.85, 0.92, 0.90, 0.85],
